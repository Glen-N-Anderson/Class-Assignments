...
char* enc_text(char* key, char* text){ //returns char array text_e which is encrypted text
        char* text_e;
...
int main(int argc, char *argv[])
{
	...
	text_e = enc_text(key, text); //call enc_text to encrypt our text using the text given and the key given	
